...
```{r {{n}}-{{nActive}}-{{eclust_distance}}jacc, opts.label = 'fig.full', eval=TRUE}
...
ggplot(DT.summary[measure=="jacc"][n=={{n}}][nActive=={{nActive}}][Ecluster_distance %in% deparse(substitute({{eclust_distance}}))],
