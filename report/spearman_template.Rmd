...
```{r {{n}}-{{nActive}}-{{eclust_distance}}spearman, opts.label = 'fig.full', eval=TRUE}
...
ggplot(DT.summary[measure=="spearman"][n=={{n}}][nActive=={{nActive}}][Ecluster_distance %in% deparse(substitute({{eclust_distance}}))],
