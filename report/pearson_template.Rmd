...
```{r {{n}}-{{nActive}}-{{eclust_distance}}pearson, opts.label = 'fig.full', eval=TRUE}
...
ggplot(DT.summary[measure=="pearson"][n=={{n}}][nActive=={{nActive}}][Ecluster_distance %in% deparse(substitute({{eclust_distance}}))],
