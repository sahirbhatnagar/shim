...
png("figures-for-manuscript/corr_all.png", width = fig.w, height = fig.h, res = fig.res)
...
png("figures-for-manuscript/corr_e0.png", width = fig.w, height = fig.h, res = fig.res)
...
png("figures-for-manuscript/corr_e1.png", width = fig.w, height = fig.h, res = fig.res)
...
## ---- heat-corr-diff ----
png("figures-for-manuscript/corr_diff.png", width = fig.w, height = fig.h, res = fig.res)
...
png("figures-for-manuscript/tom_all.png", width = fig.w, height = fig.h, res = fig.res)
...
png("figures-for-manuscript/tom_e0.png", width = fig.w, height = fig.h, res = fig.res)
...
png("figures-for-manuscript/tom_e1.png", width = fig.w, height = fig.h, res = fig.res)
...
png("figures-for-manuscript/tom_diff.png", width = fig.w, height = fig.h, res = fig.res)
...
## ---- fishers-zstat ----
png("figures-for-manuscript/corr_fisher.png", width = fig.w, height = fig.h, res = fig.res)
plot(fisherScore, truemodule = truemodule1, cluster_rows = T, cluster_cols = T,
     active = as.numeric(betaMainEffect!=0))
dev.off()

## ---- cor-scor ----
png("figures-for-manuscript/corr_scor.png", width = fig.w, height = fig.h, res = fig.res)
...
## ---- on-off ----
png("figures-for-manuscript/corr_onoff.png", width = fig.w, height = fig.h, res = fig.res)
