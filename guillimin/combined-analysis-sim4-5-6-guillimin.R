...
col.names <- fread("~/git_repositories/eclust-simulation-aug2016/hydra/results/colnames_stab_hydra-sim4-oct14.txt", header = F)$V1

DT <- fread("~/git_repositories/eclust-simulation-aug2016/hydra/results/sim4-hydra-results-p5000-oct14", stringsAsFactors = FALSE) %>%
  setnames(col.names)
...
col.names <- fread("~/git_repositories/eclust-simulation-aug2016/guillimin/results/colnames_stab_hydra-sim5-oct20.txt", header = F)$V1
...
DT <- fread("~/git_repositories/eclust-simulation-aug2016/guillimin/results/sim5-guillimin-results-p5000-oct20", stringsAsFactors = FALSE) %>%
  setnames(col.names)
...
col.names <- fread("~/git_repositories/eclust-simulation-aug2016/guillimin/results/colnames_stab_hydra-sim6-oct21.txt", header = F)$V1

DT <- fread("~/git_repositories/eclust-simulation-aug2016/guillimin/results/sim6-guillimin-results-p5000-oct21", stringsAsFactors = FALSE) %>%
  setnames(col.names)
...
options(warning.length = 8170)
DT.long <- DT %>%
  data.table::melt(id.vars = c("simulation",colnames(DT)[1:20])) %>%
  tidyr::separate(variable, c("method", "summary", "model", "interaction", "measure"), convert = T) %>%
  as.data.table
...
save_plot(sprintf("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/%s_sim456.png","tpr_fpr",05),
          p1, base_width = 8)
...
p1 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance=="TOM"][measure=="AUC"],
...
save_plot(sprintf("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/%s_sim456.png","AUC"),
...
save_plot("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/CorrectSparsity_sim456.png",
...
save_plot("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/jacc_sim456.png",
          p, base_aspect_ratio = 1.3, nrow = 1, base_width = 18, base_height = 7)
...
for (m in c("pearson","spearman")) {
  ...
  save_plot(sprintf("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/%s_sim456.png",m),
            p, base_aspect_ratio = 1.3, nrow = 1, base_width = 18, base_height = 7)
}
...
p1 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure=="jacc"][sim==4],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p2 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure=="jacc"][sim==5],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p3 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure=="jacc"][sim==6],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p1 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure==m][sim==4],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p2 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure==m][sim==5],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
save_plot(sprintf("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/%s_sim456.png","stability"),
...
p1 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure=="CorrectSparsity"][name %ni% c("enet", "lasso")][sim==4],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p2 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure=="CorrectSparsity"][name %ni% c("enet", "lasso")][sim==5],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p3 <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance == "TOM"][measure=="CorrectSparsity"][name %ni% c("MARS")][sim==6],
             aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p_auc <- ggplot(DT.long2[SNR==1][rho==0.9][cluster_distance=="TOM"][measure=="AUC"],
                 aes(x = name, y = value, fill = method)) +
  geom_boxplot(position = pd) +
  guides(color = guide_legend(title = "method")) +
  xlab("") +
...
p <- plot_grid(p_tpr_fpr, p_correct_sparsity, p_auc, nrow = 3, rel_heights = c(1,1,1), labels = c("A","B","C"))
p

save_plot(sprintf("~/git_repositories/eclust-simulation-aug2016/guillimin/results/figures/sim4-5-6-combined/%s_sim456.png","modelfit"),
          p, base_aspect_ratio = 1.3, nrow = 1, base_width = 16, base_height = 14)
